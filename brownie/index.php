...
$TotalProdutos = $dalProduto->TotalProdutos();
$estoqueTotal = $dalProduto->SomaEstoque();
$estoqueBaixo = $dalProduto->TotalEstoqueBaixo(5);
$TotalPedidos = $dalPedido->TotalPedidos();
$categoriaTotal = $dalCategoria->categoriaTotal();
$clientesTotal = $dalCliente->clientesTotal();
$valorvendidoTotal = $dalPedido->valorvendidoTotal();
$itensvendidosTotal = $dalPedido->itensvendidosTotal();
$valorestoqueTotal = $dalProduto->valorestoqueTotal();
?>
 ...
 <div class="menu_lateral">
    ...
    <a href="../brownie/index.php">
        ...
        <a href="../brownie/VIEW/produtos.php">
            ...
            Produtos</a>
        <a href="../brownie/VIEW/pedidos.php">
    ...
    <li>
        ...
        <a href="/brownie/VIEW/pedidos.php" class="dropdown-item">
    ...
    <li><hr class="dropdown-divider"></li>
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <a href="VIEW/produtos.php" class="card-link">Visualizar</a>
            </div>
        </div>
         ...
         <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Requer atenção</h6>
                <h2 class="card_info">
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <a href="VIEW/clientes.php" class="card-link">Visualizar</a>
            </div>
        </div>
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title">Quantidade Pedidos</h5>
                <h6 class="card-subtitle mb-2 text-muted">Total</h6>
                <h2 class="card_info">
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Total</h6>
                <h2 class="card_info">
                    R$<?php echo number_format($valorvendidoTotal, 2, ',', '.'); ?>
                </h2>
                <a href="VIEW/pedidos.php" class="card-link">Visualizar</a>
            </div>
        </div>

        <div class="card" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title">Quantidade Itens vendidos</h5>
                <h6 class="card-subtitle mb-2 text-muted">Total</h6>
                <h2 class="card_info">
                    <?php echo $itensvendidosTotal; ?>
                </h2>
                <a href="VIEW/pedidos.php/" class="card-link">Visualizar</a>
            </div>
        </div>
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Total</h6>
                <h2 class="card_info">
                    R$<?php echo number_format($valorestoqueTotal, 2, ',', '.'); ?>
                </h2>
                <a href="VIEW/produtos.php" class="card-link">Visualizar</a>
            </div>
        </div>
